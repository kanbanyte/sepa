...
The application domain for the system is in the field of robotics,
specifically computer vision, sensors, AI, and automation.

Similar programs are utilised in the field of industrial automation,
where they are used to automate product assembly on a factory floor or
carry out other repetitive operations that call for accuracy and precision.
For this reason, the software solution should be useable by those without knowledge of robotics so
factory floor workers can operate the system.
This can be achieved with a user friendly interface and
clear trouble shooting messages.
Vision systems allow robotic arms to see and understand its surroundings,
enabling it to carry out more difficult jobs that call for a higher level of situational awareness,
allowing for more dynamic and
complex tasks to be completed whilst reducing the need for physical labour and human interaction.

The types of jobs our system can perform are limited by the specifications of the Universal Robots UR5e robotic arm.
...
The system falls under the application domain of industrial automation and
robotics with a focus on computer vision and AI.
